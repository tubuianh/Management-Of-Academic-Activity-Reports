...
<div class="fixed-container">
    <div class="form-container">
        <div class="form-header">
            <h4 class="mb-0"><i class="fas fa-edit me-2"></i>Cập Nhật Bộ Môn: {{ $bomon->tenBoMon }}</h4>
        </div>
                ...
                <div class="form-section">
                    ...
                    <div class="section-body row">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="maBoMon" value="{{ old('maBoMon', $bomon->maBoMon) }}" readonly>
                        </div>

                        <div class="col-md-6">
                            <label for="tenBoMon" class="form-label">Tên Bộ Môn</label>
                            <input type="text" class="form-control @error('tenBoMon') is-invalid @enderror" name="tenBoMon" value="{{ old('tenBoMon', $bomon->tenBoMon) }}">
                            @error('tenBoMon')
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="truongBoMon" class="form-select @error('truongBoMon') is-invalid @enderror">
                                ...
                                @foreach ($giangviens as $gv)
                                    <option value="{{ $gv->maGiangVien }}" {{ old('truongBoMon', $bomon->truongBoMon) == $gv->maGiangVien ? 'selected' : '' }}>
                                        {{ $gv->ho }} {{ $gv->ten }}
                                    </option>
                                @endforeach
                            </select>
